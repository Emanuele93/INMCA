...
savefig('analisi/wavform.png', [y_src, y_tgt])
savefig('analisi/f0.png', [f0_src, f0_tgt], ylabel="Frequenza")
savefig('analisi/sp.png', [sp_src, sp_tgt], ylabel="Frequenza")

drawGmm([f0_src, f0_tgt], [sp_src, sp_tgt])
